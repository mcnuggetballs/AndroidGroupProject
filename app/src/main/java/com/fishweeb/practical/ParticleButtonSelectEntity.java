...
public class ParticleButtonSelectEntity implements EntityBase
{
    ...
    public static ParticleButtonSelectEntity Create(Bitmap _bmp, Bitmap _item, float xPos, float yPos, float buttonsize, float textSize)
    {
        ParticleButtonSelectEntity result = new ParticleButtonSelectEntity();
        result.Pos.x = xPos;
        result.Pos.y = yPos;
